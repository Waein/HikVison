...
import sdk.HCNetSDK;
import sdk.HCNetSDK.NET_DVR_DEVICEINFO_V40;
import sdk.HCNetSDK.NET_DVR_USER_LOGIN_INFO;
...
public class Client extends JFrame
{
	...
	public Client()
	{
		...
		arrShow = new Show[4];//change another video add num
		arrShow[0] = new Show();
		arrShow[1] = new Show();
		arrShow[2] = new Show();
		arrShow[3] = new Show();
		//...another show video add on there
		m_iChannelNum = -1;
	...
	private void initComponents()
	{
		...
		MenuItemPlayByFile.addMouseListener(new MouseAdapter()
		{
		...
		MenuItemPlayByTime.addMouseListener(new MouseAdapter()
		{
			public void mousePressed(MouseEvent evt)
			{
	...
	private void StartPlayActionPerformed(ActionEvent e)
	{
		...
		{
			//JOptionPane.showMessageDialog(Client.this, "Please select channel");
		...
		{
			//JOptionPane.showMessageDialog(Client.this, "Please login");
...
//		}
			...
			else if (selNode.toString() == "Device Tree")
			{
				...
				addDevice.addActionListener(new ActionListener()
				{
					...
					public void actionPerformed(ActionEvent e)
					{
						...
						dlg.setBounds(Client.this.getX() + Client.this.getWidth() / 4,
								Client.this.getY() + Client.this.getHeight() / 4, 440, 300);
						dlg.setVisible(true);
						dlg.setModal(true);
					}
				});
	...
	// play back by time
	private void MenuItemPlayByTimeMousePressed(MouseEvent evt)
	{
		String ip = GetTreeIp();
		if (ip == "")
		{
