...
import sdk.HCNetSDK;
import sdk.HCNetSDK.NET_DVR_PDC_ALRAM_INFO;
import sdk.HCNetSDK.NET_DVR_PLATE_RESULT;
import sdk.HCNetSDK.struAlarmChannel;
import sdk.HCNetSDK.struAlarmHardDisk;
import sdk.HCNetSDK.struIOAlarm;
import sdk.HCNetSDK.struStartTime;
import sdk.HCNetSDK.struStatFrame;
...
public class AlarmThread extends Thread {
	...
	public void AddAlarmInfo(String strInfo, HCNetSDK.NET_DVR_ALARMER pAlarmer) {
		DefaultTableModel alarmTableModel = Client.getTableModel();
